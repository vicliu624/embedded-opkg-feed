...
| Process inspection suite (source-built and merged; device pending) | `psmisc` | psmisc 23.7 is the official latest release; its locked SourceForge HTTPS archive is SHA-256 `58c55d9c1402474065adae669511c191de374b0871eec781239ab400b907c327`. Buildroot 2025.02.1's `psmisc.mk` is reviewed cross-build logic only; `PSMISC_VERSION=23.7` is guarded. Because baseline `psmisc.hash` has no 23.7 row, the transaction admits a one-row override only after exact filename/SHA-256 matching with `source.lock`, keeps normal Buildroot verification enabled, and restores the original manifest byte-for-byte. Source batch [`34006256552`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34006256552) restored—not rebuilt—the SDK, built `psmisc_23.7-1_riscv64.ipk`, passed source/ELF/closure/deny-overlay/feed/445-object gates, and uploaded [`9981057795`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34006256552/artifacts/9981057795) (90,137,169 bytes; GitHub SHA-256 `db9fcdbde1a26de09dcb5270f53213d9c5d514c1a50521243e7442eb7525f58a`). No-recompile merge [`34006620790`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34006620790) compared all 40 source-artifact manifest/IPK hashes, rebuilt the index, and passed feed verification, runtime closure, and 445-object target coverage without compiling; its SDK-base and package-build jobs were skipped. It uploaded merged unsigned artifact [`9981196020`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34006620790/artifacts/9981196020), 197,245,213 bytes with GitHub SHA-256 `3abcbefac768ad21ebe49df0d54050b0d191e2891687e495dc0899a19d53e91d`. The IPK exposes only private `fuser`, `killall`, `pslog`, `prtstat`, and `pstree` through distinct `tdvp-*` frontends, uses exact immutable `libncursesw`, and excludes RISC-V-unsupported `peekfd`. CI did not invoke those commands or inspect procfs. The artifacts remain unsigned; publication, deployment, and device lifecycle validation are pending. |
| Legacy network tools (source-built and merged; device pending) | `net-tools` | net-tools 2.10 exactly matches the fixed Buildroot 2025.02.1 recipe and official archive SHA-256 `b262435a5241e89bfa51c3cabd5133753952f7a7b7b93f32e08cb9d96f580d69`. GitHub Actions source batch [`34007398511`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007398511) restored—not rebuilt—the SDK, cross-built `net-tools_2.10-1_riscv64.ipk`, and passed locked-source, RISC-V-ELF, runtime-closure, deny-overlay, feed-verification, and 445-object target-coverage gates. It uploaded unsigned artifact [`9981425511`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007398511/artifacts/9981425511) (90,328,415 bytes; GitHub SHA-256 `9761e314772218eed4b4ee9c6fd14ef50fadfd158289b3a443fc35c80c8efc25`); SDK-base and merge jobs were skipped. No-recompile merge [`34007657490`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007657490) compared all 41 source-artifact manifest/IPK hashes, rebuilt the index, and passed feed verification, runtime closure, and 445-object target coverage without compiling; its SDK-base and source-build jobs were skipped. It uploaded unsigned merged artifact [`9981521824`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007657490/artifacts/9981521824) (197,486,158 bytes; GitHub SHA-256 `061756699b615cc167773297cec41b03562588eba3bd296aeefa3202f4f52ba2`). It is a command-only candidate: the transaction retains only selected private command ELFs and distinct `tdvp-*` frontends, never a BusyBox path, configuration/service, header, archive, pkg-config metadata, or shared-runtime ABI. CI compiled/audited only: it did not invoke a utility, read an interface, supply interface/address/route/device input, open a connection, or alter network configuration. Signing, publication, deployment, and explicitly authorized device network lifecycle validation remain pending. |
