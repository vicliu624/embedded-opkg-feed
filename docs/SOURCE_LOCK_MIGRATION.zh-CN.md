...
| CPU 限制 | `cpulimit` | GitHub Actions source batch [`33996029211`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/33996029211) 已通过经审查的私有 command leaf，不引入 shared provider；33-artifact no-recompile merge [`33996322817`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/33996322817) 随后准入已验证 IPK。CI 未执行它、传入 PID/进程名、启动进程或节流进程。 |
| 带宽监视 | `bwm-ng` | GitHub Actions source batch [`33997001920`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/33997001920) 已通过经审查的私有 command leaf，并产生 unsigned artifact [`9978397329`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/33997001920/artifacts/9978397329)（90,164,043 bytes；SHA-256 `affabae7d97bb5778227d09ae634d867a17f11f9b5a32d6d68f568a6b91fb373`）。其可选 terminal view 只消费 immutable target `libncursesw` provider，不构建或发布 runtime provider。34-artifact no-recompile merge [`33997364665`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/33997364665) 随后准入已验证 IPK、重建 index，并通过 runtime closure 与 445-object target coverage；merged artifact [`9978511004`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/33997364665/artifacts/9978511004) 的 SHA-256 是 `ffeb22475b948bc57064df291f8783f5006128c2965cab9feddb73bb766472c0`。CI 未执行监视器、读取 procfs、观察网络接口或观察磁盘 I/O；仍需要实机生命周期验证。 |
| 校验和验证 | `rhash` | GitHub Actions source batch [`33998249379`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/33998249379) 已通过经审查的私有 command leaf，并产生 unsigned artifact [`9978739567`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/33998249379/artifacts/9978739567)（90,288,593 bytes；SHA-256 `85f7c5752bfadd140bd9a34c9c7cc7069890461e23f57b5f5e63e9b670ae65c3`）。recipe 禁用 gettext/OpenSSL、静态链接 private librhash implementation 并关闭 shared-library build，因此不引入 provider。35-artifact no-recompile hash merge [`33998522557`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/33998522557) 随后准入已验证 IPK、重建 index，并通过 runtime closure 与 445-object target coverage；merged artifact [`9978839795`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/33998522557/artifacts/9978839795) 的 SHA-256 是 `6042b30b4b5e9af1d46b50c8b0a18a8e20564e189919feb5734c103251bcb14e`。CI 未执行它或传入文件路径/payload；仍需要实机生命周期验证。 |
| 非加密快速完整性 | `xxhash` | Buildroot 2025.02.1 锁定 xxHash 0.8.3；官方 GitHub tag archive 的 SHA-256 是 `aae608dfe8213dfd05d909a57718ef82f30722c392344583d3f39050c7f29a80`。GitHub Actions source batch [`34000078942`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34000078942) 恢复（没有重建）SDK，用 RISC-V toolchain 只构建/链接 `xxhsum`，并在 unsigned artifact [`9979257288`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34000078942/artifacts/9979257288) 中上传 `xxhash_0.8.3-1_riscv64.ipk`（90,122,393 bytes；GitHub SHA-256 `614f484c613a024b831ff62f3e2f440259f5260788ad28dd01756b977632c2f6`）。经审查 transaction 不构建/安装 `libxxhash`、headers 或 pkg-config metadata；run 通过 source cache、RISC-V ELF、closure、deny-overlay、feed verification 与 445-object target coverage 门。无重编 merge [`34000394791`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34000394791) 对全部 36 个 artifact manifest/IPK hash 逐一比对、重建 index，并在未编译的情况下再次通过 closure/445-object coverage；它上传 merged artifact [`9979351229`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34000394791/artifacts/9979351229)（196,935,108 bytes；GitHub SHA-256 `0c2ae26b0841902ca0e850ddb76306aaba64732e2ec8715b3240396ec5f19b7b`）。`xxhsum` 仅限受控去重和非安全预筛选，绝不用于认证、签名或安全决策；仍需实机生命周期验证。 |
...
| 快速 LZ4（已 source-build/merge；待实机） | `lz4` | 官方 [LZ4 v1.10.0 tag archive](https://github.com/lz4/lz4/releases/tag/v1.10.0) 是当前上游 release；流式 SHA-256 `537512904744b35e232912055ccf8ec66d768639ff3abe5788d90d792ec5f48b` 与 Buildroot 2025.02.1 一致。GitHub Actions source batch [`34002789451`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34002789451) 恢复（未重建）SDK，以 `BUILD_SHARED=no` 构建 Buildroot LZ4 的两个目录，生成 `lz4_1.10.0-1_riscv64.ipk`，并通过 locked source、RISC-V ELF、closure、deny-overlay、feed-verification 与 445-object target-coverage gate。unsigned artifact [`9980027622`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34002789451/artifacts/9980027622) 为 90,226,771 bytes，GitHub SHA-256 `492cc56e4c238cba213ed082db6c0eca955155d12b709711104f9c171f67b3ba`；SDK-base 与 merge job 都是 skipped。无重编 merge [`34003078163`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34003078163) 逐一比对 38 个 source-artifact manifest/IPK hash、重建 index，且在未编译情况下再次通过 feed verification、runtime closure 与 445-object target coverage；SDK-base 与 package-build job 均 skipped。它上传 unsigned merged artifact [`9980152139`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34003078163/artifacts/9980152139)，为 197,142,393 bytes，GitHub SHA-256 `0964bb1eb75080b69951c3c00808a72398d2a75651162708e79c13d1a062bdaa`。package 只提取 private `lz4`、`lz4c`、`unlz4`、`lz4cat` command 与不同的 `tdvp-` frontend，绝不生成 `liblz4.so`、`liblz4.a`、headers、pkg-config metadata 或普通 firmware command path。CI 未运行 codec、传入内容、压缩或解压数据。LZ4 frame/checksum 不是内容认证。artifact 尚未签名，仍需实机生命周期验证。 |
| 并行 LZO（已 source-build/merge；待实机） | `lzop` | 官方 HTTPS LZO 2.10 与 lzop 1.04 archive 的流式 SHA-256 分别为 `c0f892943208266f9b6543b3ae308fab6284c5c90e627931446fb49b4221a072`、`7e72b62a8a60aff5200a047eea0773a8fb205caf7acbe1774d95147f305a2f41`，与 Buildroot 2025.02.1 精确一致。GitHub Actions source batch [`34004037276`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34004037276) 恢复（未重建）SDK，实际以 `-DENABLE_SHARED=OFF -DENABLE_STATIC=ON` 配置 LZO；日志记录 `liblzo2.a` link 而非 shared object。它交叉构建 `lzop_1.04-1_riscv64.ipk`，通过 locked-source、RISC-V ELF、deny-overlay、feed-verification、runtime-closure 与 445-object target-coverage gate；SDK-base 与 merge job 均 skipped。unsigned artifact [`9980420311`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34004037276/artifacts/9980420311) 为 90,140,564 bytes，GitHub SHA-256 `698a96674a57f637128102e0c8d15264de49f727e9862f919f36a5cc7ee53cad`。无重编 merge [`34004352420`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34004352420) 逐一比对 39 个 source-artifact manifest/IPK hash、重建 index，且在未编译情况下再次通过 feed verification、runtime closure 与 445-object target coverage；SDK-base 与 package-build job 均 skipped。它上传 unsigned merged artifact [`9980529319`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34004352420/artifacts/9980529319)，为 197,195,504 bytes，GitHub SHA-256 `0847c8f87bb8c3d647a5aed9c27bf8f3e442521ba32e96cb81d404390b1f3201`。generic helper 只把 private `lzop` 提取到 `/usr/libexec/tdvp-lzop`，由 `tdvp-lzop` frontend 使用，绝不生成 `liblzo2.so`、`liblzo2.a`、headers、pkg-config metadata 或普通 firmware path。任何残留 `liblzo2` runtime dependency 必须 fail-closed。CI 未运行 codec、传入内容、压缩或解压数据。LZO/LZOP frame/checksum 不是内容认证。所有 artifact 未签名、发布、部署或在设备执行，仍需实机生命周期验证。 |
| 并行 gzip（已 source-build/merge；待实机） | `pigz` | 官方 [pigz 2.8 source release](https://zlib.net/pigz/) 是当前上游 release；SHA-256 `eb872b4f0e1f0ebe59c9f7bd8c506c4204893ba6a8492de31df416f0d5170fd0` 与 Buildroot 2025.02.1 锁定值一致。run [`34001374220`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34001374220) 从原 zlib.net 传输端取得 12,031 bytes、SHA-256 `8873b211638620c1cbb32ed01a1d6e03ea928a8842566216d2d8040248b97a0c` 的错误内容，所以 source-cache 在实际编译前以 exit 69 拒绝。仅在 OmniOS 公共 HTTPS mirror 的 121,304-byte archive 被独立流式复算为同一上游/Buildroot hash 后，`source.lock` 才切换传输端；这不是源码替换或放宽散列。GitHub Actions source batch [`34001592645`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34001592645) 恢复（未重建）SDK，用 `riscv64-unknown-linux-gnu-gcc` 交叉编译 `pigz`，生成 `pigz_2.8-1_riscv64.ipk`，并通过 locked source、RISC-V ELF、closure、deny-overlay、feed-verification 与 445-object target-coverage gate。unsigned artifact [`9979676644`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34001592645/artifacts/9979676644) 为 90,155,403 bytes，GitHub SHA-256 `a022179609394e636be83251319b31af957d52fd47366fcf78bc15058c3791c4`。无重编 merge [`34001947527`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34001947527) 逐一比对 37 个 source-artifact manifest/IPK hash、重建 index，并在未编译的情况下再次通过 runtime closure 与 445-object target coverage；其 SDK-base 与 source-build job 都是 skipped。它上传 unsigned merged artifact [`9979808940`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34001947527/artifacts/9979808940)（197,003,060 bytes；GitHub SHA-256 `ad8f399d2cbdb0ea1101ce7cb4c03ceb0063021018d968e4da8222f4153950e6`）。recipe 仅以 `tdvp-pigz` 提供 private ELF，绝不替换 BusyBox `gzip`，只消费 immutable `libz` 精确 provider；禁止 zlib、headers、静态 archive 或其他 shared-runtime ABI 进入 IPK。CI 未运行 pigz、传入内容、压缩或解压数据；压缩和 CRC 不是内容认证。任何 artifact 均未签名、发布、部署或在设备执行；仍需实机生命周期验证。 |

| 进程诊断套件（已 source-build/merge；待实机） | `psmisc` | psmisc 23.7 官方 archive 的锁定 SHA-256 是 `58c55d9c1402474065adae669511c191de374b0871eec781239ab400b907c327`。Buildroot 2025.02.1 的 `psmisc.mk` 只用作受审交叉构建逻辑，受限 `PSMISC_VERSION=23.7` 覆盖其基线 23.5。因为基线 `psmisc.hash` 没有 23.7 行，事务仅在 archive 名称和 SHA-256 与 `source.lock` 唯一精确匹配后临时提供一行 override；普通 Buildroot 哈希校验保持开启，原清单无论成功或失败均按字节还原。GitHub Actions source batch [`34006256552`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34006256552) 恢复而非重建 SDK，从锁定 cache 构建 `psmisc_23.7-1_riscv64.ipk`，通过 source cache、RISC-V ELF、runtime closure、deny overlay、feed verification 与 445-object target coverage，上传 unsigned artifact [`9981057795`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34006256552/artifacts/9981057795)（90,137,169 bytes；GitHub SHA-256 `db9fcdbde1a26de09dcb5270f53213d9c5d514c1a50521243e7442eb7525f58a`）。无重编 merge [`34006620790`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34006620790) 逐一比对全部 40 个 source-artifact manifest/IPK hash、重建 index，并在未编译情况下通过 feed verification、runtime closure 和 445-object target coverage；SDK-base 与 package-build job 均 skipped。它上传 merged unsigned artifact [`9981196020`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34006620790/artifacts/9981196020)（197,245,213 bytes；GitHub SHA-256 `3abcbefac768ad21ebe49df0d54050b0d191e2891687e495dc0899a19d53e91d`）。IPK 只能包含 private `fuser`、`killall`、`pslog`、`prtstat`、`pstree` ELF 和不同的 `tdvp-*` frontend；精确使用 immutable `libncursesw (= 6.4-20230603-1)`，不发布 shared ABI 或普通 firmware path，排除无 RISC-V 实现的 `peekfd`。CI 禁止运行命令、检查 procfs、传入 PID/名称/路径/socket、发送信号或遍历真实进程树。artifact 仍未签名，签名、发布、部署和实机生命周期验证仍待完成。 |
| 旧式网络工具（已 source-build/merge；待实机） | `net-tools` | net-tools 2.10 与固定 Buildroot 2025.02.1 的 recipe 和官方 archive SHA-256 `b262435a5241e89bfa51c3cabd5133753952f7a7b7b93f32e08cb9d96f580d69` 精确一致。GitHub Actions source batch [`34007398511`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007398511) 恢复而非重建 SDK，交叉构建 `net-tools_2.10-1_riscv64.ipk`，并通过 locked source、RISC-V ELF、runtime closure、deny-overlay、feed verification 与 445-object target coverage gate。它上传 unsigned artifact [`9981425511`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007398511/artifacts/9981425511)（90,328,415 bytes；GitHub SHA-256 `9761e314772218eed4b4ee9c6fd14ef50fadfd158289b3a443fc35c80c8efc25`）；SDK-base 与 merge job 均 skipped。无重编 merge [`34007657490`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007657490) 逐一比对全部 41 个 source-artifact manifest/IPK hash、重建 index，并在未编译情况下通过 feed verification、runtime closure 和 445-object target coverage；SDK-base 与 source-build job 均 skipped。它上传 merged unsigned artifact [`9981521824`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007657490/artifacts/9981521824)（197,486,158 bytes；GitHub SHA-256 `061756699b615cc167773297cec41b03562588eba3bd296aeefa3202f4f52ba2`）。它是 command-only 候选：事务只能保留 selected private command ELF 与不同的 `tdvp-*` frontend，绝不包含 BusyBox path、配置/服务、headers、archive、pkg-config metadata 或 shared-runtime ABI。CI 只编译/审计：未执行命令、读取接口、传入 interface/address/route/device、建立连接或修改网络配置。签名、发布、部署和获得明确授权后的设备侧网络生命周期验证仍待完成。 |
