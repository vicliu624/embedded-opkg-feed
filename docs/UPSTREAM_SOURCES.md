...
22. Completed `net-tools 2.10` source admission: source batch [`34007398511`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007398511) restored—not rebuilt—the SDK, used the exact Buildroot 2025.02.1 source version/digest, cross-built `net-tools_2.10-1_riscv64.ipk`, and passed source, RISC-V ELF, dependency-closure, feed, and 445-object target-coverage gates. It uploaded unsigned artifact [`9981425511`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007398511/artifacts/9981425511), 90,328,415 bytes with GitHub SHA-256 `9761e314772218eed4b4ee9c6fd14ef50fadfd158289b3a443fc35c80c8efc25`; SDK-base and merge jobs were skipped. The IPK exposes only the reviewed private `tdvp-arp`, `tdvp-ifconfig`, `tdvp-ipmaddr`, `tdvp-iptunnel`, `tdvp-mii-tool`, `tdvp-nameif`, `tdvp-netstat`, `tdvp-plipconfig`, `tdvp-rarp`, `tdvp-route`, and `tdvp-slattach` frontends. CI cross-built and audited only; it neither invoked the tools nor queried or changed network state. Its no-recompile merge, signing, publication, and device lifecycle validation remain pending; then
