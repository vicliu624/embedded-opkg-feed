...
20. Emit source provenance/SBOM material for each release and bind source, SDK,
   and test evidence to the signed release; then
21. Introduce reviewed general libraries incrementally, retaining shared-runtime
