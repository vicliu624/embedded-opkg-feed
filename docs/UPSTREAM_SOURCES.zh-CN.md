...
22. 已完成 `net-tools 2.10` source 准入：source batch [`34007398511`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007398511) 恢复而非重建 SDK，采用与 Buildroot 2025.02.1 完全一致的源码版本/摘要，交叉构建 `net-tools_2.10-1_riscv64.ipk`，并通过 source、RISC-V ELF、dependency closure、feed 和 445-object target coverage gate。它上传 unsigned artifact [`9981425511`](https://github.com/vicliu624/embedded-opkg-feed/actions/runs/34007398511/artifacts/9981425511)（90,328,415 bytes；GitHub SHA-256 `9761e314772218eed4b4ee9c6fd14ef50fadfd158289b3a443fc35c80c8efc25`）；SDK-base 与 merge job 均 skipped。IPK 仅提供经审核的私有 `tdvp-arp`、`tdvp-ifconfig`、`tdvp-ipmaddr`、`tdvp-iptunnel`、`tdvp-mii-tool`、`tdvp-nameif`、`tdvp-netstat`、`tdvp-plipconfig`、`tdvp-rarp`、`tdvp-route` 与 `tdvp-slattach` 前端。CI 只交叉构建并审计，既不调用这些工具，也不查询或改变网络状态。无重编 merge、签名、发布和实机生命周期验证仍待完成；然后
