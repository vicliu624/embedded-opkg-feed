...
archive and restores the platform Kconfig byte-for-byte. GitHub Actions must
validate the lock, RISC-V ELF machine, no RPATH/RUNPATH, IPK runtime closure,
and base-overlay policy before uploading an unsigned candidate.
