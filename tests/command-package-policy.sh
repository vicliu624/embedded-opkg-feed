...
grep -Fqx "PACKAGE_DEPENDS='libncursesw (= 6.4-20230603-1), libcap-2 (= 2.73-1)'" "$repo_root/packages/htop/package.env"
grep -Fqx "PACKAGE_BUILD_DEPENDS='libncursesw libcap-2'" "$repo_root/packages/htop/package.env"
grep -Fq 'same selected partial closure first builds libcap-2' "$repo_root/packages/htop/build.sh"
