...
grep -Fqx "PACKAGE_SDK_DEVELOPMENT_DEPENDS='libncursesw'" "$repo_root/packages/less/package.env"
...
grep -Fqx "PACKAGE_SDK_DEVELOPMENT_DEPENDS='libncursesw'" "$repo_root/packages/libreadline/package.env"
...
grep -Fqx "PACKAGE_DEPENDS='libncursesw (= 6.4-20230603-1), libcap-2 (= 2025.02.1-1)'" "$repo_root/packages/htop/package.env"
grep -Fqx "PACKAGE_SDK_DEVELOPMENT_DEPENDS='libncursesw'" "$repo_root/packages/htop/package.env"
...
grep -Fqx "PACKAGE_SDK_DEVELOPMENT_DEPENDS='libncursesw'" "$repo_root/packages/nano/package.env"
