...
grep -Fqx "PACKAGE_BUILD_DEPENDS='libncursesw'" "$repo_root/packages/dialog/package.env"
grep -Fqx 'PACKAGE_SOURCE_STAGING=1' "$repo_root/packages/libncursesw/package.env"
