...
# The released-image ownership inventory carries libatomic.  It is therefore
# generated by the target runtime catalogue, not duplicated in the optional
# source-built extra-owner table.
! grep -Eq '^libatomic[.]so[.]1[|]' "$repo_root/platforms/tdvp-k230-r1/extra-runtime-owners.tsv"
