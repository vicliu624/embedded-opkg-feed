...
expect_line "PACKAGE_SDK_DEVELOPMENT_DEPENDS='libz-1 libexpat-1 libffi-8 libssl-3 libcrypto-3 libncursesw-6 libreadline-8'" \
  "$repo_root/packages/libpython3.13/package.env"
expect_line "PACKAGE_DEPENDS='libpython3.13 (= 3.13.3-1), libbz2 (= 1.0.8-1), liblzma (= 5.6.4-1), libz-1 (= 2025.02.1-1), libncursesw-6 (= 2025.02.1-1), libreadline-8 (= 2025.02.1-1), libexpat-1 (= 2025.02.1-1), libffi-8 (= 2025.02.1-1), libmpdec-4 (= 4.0.0-1), libsqlite3-0 (= 3.48.0-1), libssl-3 (= 2025.02.1-1), libcrypto-3 (= 2025.02.1-1), ca-certificates (= 2025.02.1-1)'" \
