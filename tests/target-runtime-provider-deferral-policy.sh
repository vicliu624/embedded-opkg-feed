...
grep -Fq 'options: [archive, audacious-foundation, audacious-core, audacious-plugins, audacious-app, audacious, network-tools, netsurf, desktop-tools, development-tools, nodejs]' "$repo_root/.github/workflows/build-r10-batch-candidate.yml"
