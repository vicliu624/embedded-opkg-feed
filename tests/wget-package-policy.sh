...
expect_line "^PACKAGE_BUILD_DEPENDS='ca-certificates'$" "$package_dir/package.env"
expect_line "^PACKAGE_SDK_DEVELOPMENT_DEPENDS='libssl-3 libcrypto-3 libz'$" "$package_dir/package.env"
...
expect_line "^SOURCE_ARTIFACT_3_FILE='pkgconf-2[.]3[.]0[.]tar[.]xz'$" "$package_dir/source.lock"
expect_line 'host-lzip required to unpack wget-1.25.0.tar.lz' "$package_dir/source.lock"
