...
expected_options='options: [archive, audacious, network-tools, http-transfer-tools, secure-transfer-tools, desktop-tools, retro-gba, development-tools, database-tools, calculator-tools, coreutils-tools, fat-media-tools, fat-filesystem-tools, exfat-filesystem-tools, memory-diagnostic-tools, directory-tree-tools, terminal-pager-tools, media-inspection-tools, system-tools, nodejs]'

grep -Fq "$expected_options" "$workflow"
for batch in archive audacious network-tools http-transfer-tools secure-transfer-tools desktop-tools retro-gba development-tools database-tools calculator-tools coreutils-tools fat-media-tools fat-filesystem-tools exfat-filesystem-tools memory-diagnostic-tools directory-tree-tools terminal-pager-tools media-inspection-tools system-tools nodejs; do
